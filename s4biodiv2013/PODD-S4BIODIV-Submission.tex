...
needs, BagIt-conforming tools \cite{Summers} [8] [9] were assessed and where necessary,
...
needed to be addressed. Neither \cite{Summers} nor [8] permitted payload files in a bag to
